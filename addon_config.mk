...
meta:
	ADDON_NAME = ofxQuadtree
	ADDON_DESCRIPTION = Implementation of a Quadtree tree for 2d neighborhood generation.
	ADDON_AUTHOR = @russtheaerialist
	ADDON_TAGS = "graphics" "template"
	ADDON_URL = http://github.com/livecodeseattle/ofxQuadtree
